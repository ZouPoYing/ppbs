...
import com.graduation.ppbs.service.FileService;
import com.graduation.ppbs.service.SetService;
import com.graduation.ppbs.service.UserService;
import com.graduation.ppbs.utils.FileDownLoad;
import com.graduation.ppbs.utils.FileUploadUtil;
...
public class SetController {
    ...
    public Map<String, Object> getSetFile(@RequestBody Map<String, String> params) throws Exception {
        ...
        com.graduation.ppbs.dao.File file = fileService.getFileByFileid(set.getFileid());
        result.put("success", true);
    ...
    public void downloadFile(@PathVariable("filename") String filename, HttpServletRequest request, HttpServletResponse response) {
        //1.获取文件绝对路径
        String path = "D:/IDEAProject/ppbs/src/main/resources/static/" + filename;
        //2.通过绝对路径定义File
